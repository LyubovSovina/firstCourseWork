...
function PrintResult(matr, m, n){
  ...
  p1.innerText += 'Суммой матриц одинакового размера называется матрица того же размера, каждый элемент которой равен сумме соответствующих элементов исходных матриц.';
  let p2 = document.createElement('p');
  p2.innerText += 'Сумма исходных матриц равна: '
